...
if __name__ == "__main__":
    ...
    max_length = 3100  # adjust as needed
    ...
    gradient_clipping = 0.7  # adjust as needed
    ...
    train_ds = ["../data/mistral_style_data/train_data.jsonl"]
    val_ds = ["../data/mistral_style_data/dev_data.jsonl"]
